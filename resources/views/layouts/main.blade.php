                ...
                <div class="container" data-aos="fade-up">
                    <div class="row about-container">
                        <div class="offset-lg-2 col-lg-8 content order-lg-1 order-2">
                            ...
                            <div class="icon-box" data-aos="fade-up" data-aos-delay="100" hidden>
                                <div class="icon">
                            ...
                            <div class="icon-box" data-aos="fade-up" data-aos-delay="200" hidden>
                                <div class="icon">
                            ...
                            <div class="icon-box" data-aos="fade-up" data-aos-delay="300" hidden>
                                <div class="icon">
                        ...
                        <div class="col-lg-6 background order-lg-2 order-1" data-aos="fade-left" data-aos-delay="100" hidden></div>
                    </div>
                </div>
